...
DROP SCHEMA IF EXISTS `u21494305_u24856462_northwind`;
CREATE SCHEMA IF NOT EXISTS `u21494305_u24856462_northwind` DEFAULT CHARACTER SET latin1 ;
USE `u21494305_u24856462_northwind`;

-- -----------------------------------------------------
-- Table `northwind`.`customers`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `u21494305_u24856462_northwind`.`customers` (
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `u21494305_u24856462_northwind`.`employees` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  `company` VARCHAR(50) NULL DEFAULT NULL,
  `last_name` VARCHAR(50) NULL DEFAULT NULL,
  `first_name` VARCHAR(50) NULL DEFAULT NULL,
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `u21494305_u24856462_northwind`.`privileges` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `u21494305_u24856462_northwind`.`employee_privileges` (
  ...
  CONSTRAINT `fk_employee_privileges_employees`
    ...
    REFERENCES `u21494305_u24856462_northwind`.`employees` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_employee_privileges_privileges`
    FOREIGN KEY (`privilege_id`)
    REFERENCES `u21494305_u24856462_northwind`.`privileges` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `u21494305_u24856462_northwind`.`inventory_transaction_types` (
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `u21494305_u24856462_northwind`.`shippers` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  `company` VARCHAR(50) NULL DEFAULT NULL,
  `last_name` VARCHAR(50) NULL DEFAULT NULL,
  `first_name` VARCHAR(50) NULL DEFAULT NULL,
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `u21494305_u24856462_northwind`.`orders_tax_status` (
  `id` TINYINT(4) NOT NULL,
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `u21494305_u24856462_northwind`.`orders_status` (
  `id` TINYINT(4) NOT NULL,
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `u21494305_u24856462_northwind`.`orders` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `fk_orders_customers`
    ...
    REFERENCES `u21494305_u24856462_northwind`.`customers` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  ...
  CONSTRAINT `fk_orders_shippers`
    ...
    REFERENCES `u21494305_u24856462_northwind`.`shippers` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_orders_orders_tax_status`
    FOREIGN KEY (`tax_status_id`)
    REFERENCES `u21494305_u24856462_northwind`.`orders_tax_status` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_orders_orders_status`
    FOREIGN KEY (`status_id`)
    REFERENCES `u21494305_u24856462_northwind`.`orders_status` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `u21494305_u24856462_northwind`.`products` (
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `u21494305_u24856462_northwind`.`purchase_order_status` (
  `id` INT(11) NOT NULL,
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `u21494305_u24856462_northwind`.`suppliers` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  `company` VARCHAR(50) NULL DEFAULT NULL,
  `last_name` VARCHAR(50) NULL DEFAULT NULL,
  `first_name` VARCHAR(50) NULL DEFAULT NULL,
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `u21494305_u24856462_northwind`.`purchase_orders` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `fk_purchase_orders_purchase_order_status`
    FOREIGN KEY (`status_id`)
    REFERENCES `u21494305_u24856462_northwind`.`purchase_order_status` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_purchase_orders_suppliers`
    FOREIGN KEY (`supplier_id`)
    REFERENCES `u21494305_u24856462_northwind`.`suppliers` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `u21494305_u24856462_northwind`.`inventory_transactions` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `fk_inventory_transactions_orders`
    ...
    REFERENCES `u21494305_u24856462_northwind`.`orders` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_inventory_transactions_products`
    FOREIGN KEY (`product_id`)
    REFERENCES `u21494305_u24856462_northwind`.`products` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_inventory_transactions_purchase_orders`
    FOREIGN KEY (`purchase_order_id`)
    REFERENCES `u21494305_u24856462_northwind`.`purchase_orders` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_inventory_transactions_inventory_transaction_types`
    FOREIGN KEY (`transaction_type`)
    REFERENCES `u21494305_u24856462_northwind`.`inventory_transaction_types` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `u21494305_u24856462_northwind`.`invoices` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `u21494305_u24856462_northwind`.`order_details_status` (
  `id` INT(11) NOT NULL,
  `status_name` VARCHAR(50) NOT NULL,
  PRIMARY KEY (`id`))
ENGINE = InnoDB
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `u21494305_u24856462_northwind`.`order_details` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `fk_order_details_order_details_status`
    FOREIGN KEY (`status_id`)
    REFERENCES `u21494305_u24856462_northwind`.`order_details_status` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `u21494305_u24856462_northwind`.`purchase_order_details` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `fk_purchase_order_details_inventory_transactions`
    ...
    REFERENCES `u21494305_u24856462_northwind`.`inventory_transactions` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `u21494305_u24856462_northwind`.`sales_reports` (
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `u21494305_u24856462_northwind`.`strings` (
